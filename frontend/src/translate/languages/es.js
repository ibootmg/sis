  ...
  es: {
    translations: {
      ...
      reports: {
        ...
        ticketDuration: {
          title: "Informe de Duración de Atenciones",
          contact: "Contacto",
          open: "Abiertos",
          pending: "Pendientes",
      ...
      connections: {
        ...
        status: {
          ...
          opening: "Abriendo Conexión",
          qrcode: "lee el código QR",
        },
        confirmationModal: {
          ...
          disconnectMessage:
            "¿Estás seguro? Tendrás que leer el código QR nuevamente.",
        },
        buttons: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          queueRedirectionDesc:
            "Selecciona una cola para que los contactos sin cola sean redirigidos",
          default: "Predeterminado",
          group: "Permitir grupos",
          timeSendQueue: "Tiempo en minutos para redirigir a la cola",
          importAlert:
            "ATENCIÓN: Al guardar, tu conexión será terminada, será necesario leer nuevamente el código QR para importar los mensajes",
          ...
          lgpdDeletedMessages: "Ocultar mensajes eliminados por el contacto",
        ...
        errorSendQueue:
          "Se informó un tiempo para redirigir a la cola, pero no se seleccionó ninguna cola. Ambos campos deben estar completos",
        errorExpiresNPS:
          "Es obligatorio informar un tiempo para la evaluación cuando se usa NPS.",
        errorRatingMessage:
          "Es obligatorio informar un mensaje de evaluación cuando se usa NPS.",
      },
      qrCode: {
      ...
      contacts: {
        ...
        menu: {
          ...
          importToExcel: "Importar/Exportar a Excel",
        },
      },
      forwardMessage: {
        text: "Reenviado",
      ...
      queueModal: {
        title: {
          ...
          edit: "Editar cola",
          confirmationDelete:
            "¿Estás seguro? Se eliminarán todas las opciones de integraciones.",
        },
        form: {
          name: "Nombre",
          color: "Color",
      ...
      userModal: {
        warning:
          "¡Para importar los mensajes es necesario leer el código QR nuevamente!",
        title: {
          add: "Agregar usuario",
          edit: "Editar usuario",
      ...
      tagModal: {
        ...
        form: {
          ...
          rollbackLaneId: "Volver a la Lane después de retomar la atención",
        },
        buttons: {
          okAdd: "Agregar",
          okEdit: "Guardar",
      ...
      messagesAPI: {
        ...
        API: {
          ...
          instructions: {
            ...
            comments1:
              "Antes de enviar mensajes, es necesario registrar el token vinculado a la conexión que enviará los mensajes. <br />Para realizar el registro, accede al menú 'Conexiones', haz clic en el botón de editar de la conexión e inserta el token en el campo correspondiente.",
            comments2:
          ...
          text: {
            ...
            instructions:
              "A continuación, se presenta la lista de información necesaria para enviar mensajes de texto:",
          },
          media: {
            title: "2. Mensajes de Medios",
            instructions:
              "A continuación, se presenta la lista de información necesaria para enviar mensajes de medios:",
          },
        },
      },
      notifications: {
      ...
      campaigns: {
        ...
        dialog: {
          ...
          help: "Utiliza variables como {nombre}, {número}, {email} o define variables personalizadas.",
          form: {
            name: "Nombre",
            message1: "Mensaje 1",
            message2: "Mensaje 2",
      ...
      queues: {
        ...
        confirmationModal: {
          deleteTitle: "Eliminar",
          deleteMessage:
            "¿Estás seguro? ¡Esta acción no se puede deshacer! Las atenciones de esta cola seguirán existiendo, pero no tendrán ninguna cola asignada.",
        },
      },
      queue: {
        queueData: "Datos",
      ...
      settings: {
        ...
        settings: {
          ...
          options: {
            ...
            sendMsgTransfTicket:
              "Enviar mensaje de transferencia de departamento/asistente",
            ...
            acceptAudioMessageContact:
              "¿Aceptar audio de todos los contactos?",
